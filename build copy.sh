...
start_slave_stmt="CHANGE MASTER TO MASTER_HOST='mysql_master',MASTER_USER='s9_slave',MASTER_PASSWORD='CwrcxxTB72zDBZEw',MASTER_LOG_FILE='$CURRENT_LOG',MASTER_LOG_POS=$CURRENT_POS; START SLAVE;"
